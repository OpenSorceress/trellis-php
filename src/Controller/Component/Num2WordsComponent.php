 ...
 * Num2Words component
 */
class Num2WordsComponent extends Component
{
    /**
     ...
     * @return string
     */
    protected function readNum($num):string
    {
        $word = "";
        if ($this->length > 3) {
    ...
    /**
     * @param int $number
     * @return Num2WordsComponent
     */
    public function setNumber(int $number): Num2WordsComponent
    {
        $this->number = $number;
        return $this;
    }
